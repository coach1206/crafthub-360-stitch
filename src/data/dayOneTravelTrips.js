/**
 * DayOne360 Travel — local fallback trip catalog.
 * Mirrors server/data/dayOneTravel.js shape; used only if the live
 * /api/travel/trips request fails so the screen never blanks out.
 */
...
export const TRIPS = [
  {
    ...
    img: craftImages.fallbacks.cigar,
  },
  {
    ...
    img: craftImages.fallbacks.lounge,
  },
  {
    ...
    img: craftImages.fallbacks.whiskey,
  },
]
