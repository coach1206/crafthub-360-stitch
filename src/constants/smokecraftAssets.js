 ...
 *   provides the correct "First Third" labeling. When a distinct first-third visual is
 *   approved, update FIRST_THIRD here only.
 *
...
export const PAIRING_LAB      = `${BASE}/smokecraft-pairing-lab.png`
...
// React overlay relabels correctly. Replace with dedicated asset when approved.
...
export const SMOKECRAFT_ASSET_MANIFEST = [
  ...
  { route: '/smokecraft',             asset: LANDING,            type: 'landing',          stale: false, overlay: 'hotspots' },
  ...
  { route: '/smokecraft/pairing-lab', asset: PAIRING_LAB,        type: 'journey',          stale: false, overlay: 'hotspots' },
