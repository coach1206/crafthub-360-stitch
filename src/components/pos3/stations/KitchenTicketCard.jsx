/**
 * KitchenTicketCard — touch card for a single kitchen queue entry with
 * Start/Ready/Complete transition buttons (48px touch targets).
 */
import { Pill, GOLD, PANEL2, LINE } from '../../eat/ui.jsx'
import TouchButton from '../TouchButton.jsx'

export default function KitchenTicketCard({ entry, onStart, onReady, onComplete }) {
  return (
