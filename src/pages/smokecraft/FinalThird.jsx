  ...
  return (
    <div className="bg-background text-on-surface font-body-md overflow-x-hidden min-h-screen">
      <div className="fixed inset-0 -z-20 bg-background overflow-hidden">
        <div className="absolute inset-0 bg-cover bg-center opacity-20" style={{ backgroundImage:"url('/assets/smokecraft/cropped/final-third-bg.png')" }} />
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_360px] items-start">
          ...
          >
            <div
              ...
              style={{ height: 180, backgroundImage:"url('/assets/smokecraft/cropped/final-third-bg.png')" }}
            />
