  ...
  return (
    <div className="min-h-screen bg-background text-on-surface font-body-md overflow-x-hidden">
      ...
      <main className="pt-28 pb-28 px-margin max-w-[800px] mx-auto">
        ...
        <img src="/assets/smokecraft-reference/approved/smokecraft-golden-box-status.png" alt="Golden Box Status" style={{ display: 'block', width: '100%', height: 'auto', objectFit: 'contain', marginBottom: 28 }} />
