    ...
    <div className="bg-background text-on-surface font-body-md overflow-x-hidden min-h-screen">
      ...
      <main className="relative pt-28 pb-36 px-6 max-w-[800px] mx-auto">
        ...
        <div className="flex flex-col gap-4 mb-12">
          {[
            { id:'request', icon:'store', label:'Request from Humidor', desc:'A staff member will retrieve your selected cigar from the house humidor.' },
            { id:'have',    icon:'smoking_rooms', label:'I Already Have My Cigar', desc:'You have your cigar ready. Proceed to cut, toast, and light.' },
          ].map(o => {
