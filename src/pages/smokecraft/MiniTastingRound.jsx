  ...
  return (
    <div className="bg-background text-on-surface font-body-md overflow-x-hidden min-h-screen">
      <div className="fixed inset-0 -z-20 bg-background overflow-hidden">
        <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: "url('/assets/smokecraft/cropped/mini-tasting-bg.jpg')", opacity: 0.5 }} />
      ...
      <main className="relative pt-28 pb-36 px-6 max-w-[800px] mx-auto">
        ...
        <p className="font-body-lg text-body-lg text-on-surface-variant mb-10" style={{ maxWidth: 560 }}>A quick check-in on your second cigar — note what stands out so far.</p>
