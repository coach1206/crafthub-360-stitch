...
import { GOLD, GOLD_DIM, CREAM, BORDER, GLASS, heroBannerStyle, pageShellStyle, cardStyle, sectionLabelStyle } from '../../constants/smokecraftLiveScreenTokens.js'
  ...
  return (
    <SmokeCraftScreenShell mode="live" status="ready">
      <div style={pageShellStyle}>
        ...
        {/* Shared decorative banner (src/constants/smokecraftLiveScreenTokens.js
            — no image asset; no approved photo is mapped to this screen). */}
