  ...
  return (
    <div aria-hidden="true" style={{ position: 'fixed', inset: 0, zIndex: 0, pointerEvents: 'none', overflow: 'hidden', background: BG }}>
      <div style={{
        position: 'absolute',
        inset: 0,
        backgroundImage: 'linear-gradient(90deg,rgba(5,3,2,0.98) 0%,rgba(5,3,2,0.74) 35%,rgba(5,3,2,0.62) 62%,rgba(5,3,2,0.97) 100%), linear-gradient(180deg,rgba(5,3,2,0.7) 0%,rgba(5,3,2,0.2) 38%,rgba(5,3,2,0.96) 100%), url(/assets/smokecraft/cropped/golden-box-hero-v2.jpg)',
      ...
      <div style={{
        ...
        aspectRatio: '1.2',
        borderRadius: 28,
        backgroundImage: 'linear-gradient(90deg,rgba(5,3,2,0.52),rgba(5,3,2,0.12)), url(/assets/smokecraft/cropped/scorecard-bg-v2.jpg)',
        backgroundSize: 'cover',
        backgroundPosition: 'center',
        opacity: 0.24,
        ...
        <div style={{
          ...
          <div style={{ padding: '16px 4px 16px 16px' }}>
            ...
            <div style={{ position: 'relative', borderRadius: 18, overflow: 'hidden', marginBottom: 16, minHeight: 220, border: `1px solid ${BORDERHI}`, boxShadow: '0 18px 46px rgba(0,0,0,0.48), 0 0 42px rgba(201,168,76,0.18)' }}>
              <img src="/assets/smokecraft/cropped/golden-box-hero-v2.jpg" alt="" style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center 42%', filter: 'brightness(0.38) saturate(1.2) contrast(1.16)' }} onError={e => e.target.style.display = 'none'} />
              <img src="/assets/smokecraft/cropped/scorecard-bg-v2.jpg" alt="" style={{ position: 'absolute', right: -26, top: -44, width: '54%', height: '125%', objectFit: 'cover', opacity: 0.62, filter: 'brightness(0.8) saturate(1.16)', borderRadius: 22 }} onError={e => e.target.style.display = 'none'} />
