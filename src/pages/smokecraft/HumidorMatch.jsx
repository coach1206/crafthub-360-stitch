  ...
  return (
    <div className="humidor-page text-on-surface font-body-md overflow-x-hidden min-h-screen">
      ...
      <main className="relative pt-28 pb-36 px-6 sm:px-[6vw] max-w-[1400px] mx-auto">
        ...
        >
          <img src="/assets/smokecraft-reference/approved/smokecraft-humidor-match.png" alt="Humidor Match" style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center' }} />
          <div
            className="w-full"
            style={{
          ...
          >
            <p className="font-label-sm text-label-sm uppercase tracking-[0.25em] mb-1" style={{ color: '#f3d49a', textShadow: '0 2px 6px rgba(0,0,0,0.6)' }}>Humidor Match</p>
            <p className="font-body-md text-[14px] text-white/80" style={{ maxWidth: 560, textShadow: '0 1px 4px rgba(0,0,0,0.6)' }}>Tune your cigar's storage environment before the session begins.</p>
          </div>
        </div>
