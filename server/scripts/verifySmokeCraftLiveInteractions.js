...
if (rp) {
  ...
  check('triggerHaptic called', rp.includes('triggerHaptic'))
}
...
if (ft) {
  ...
  check('Flavor notes rendered as clickable buttons', ft.includes('aria-pressed') && ft.includes('onClick'))
...
if (st) {
  ...
  check('Flavor notes are clickable buttons', st.includes('aria-pressed') && st.includes('onClick'))
...
if (fm) {
  ...
  check('Chips are clickable buttons', fm.includes('aria-pressed') && fm.includes('onClick'))
...
if (fth) {
  ...
  check('Flavor notes are clickable buttons', fth.includes('aria-pressed') && fth.includes('onClick'))
