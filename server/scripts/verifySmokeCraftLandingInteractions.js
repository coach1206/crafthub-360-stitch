...
if (identity) {
  check('Identity imports awardSessionRewards', identity.includes('awardSessionRewards'))
  check("Identity awards 'enroll' session on hotspot click",
...
if (hotspotLayer) {
  ...
  check('Active/press state has sc-tap-flash animation',
    hotspotLayer.includes('sc-tap-flash'))
...
// ── Gate 4: TicketTapperSpecialsStrip — marquee + placeholder ─────────────────
console.log('\nGate 4 — TicketTapperSpecialsStrip: marquee motion + empty placeholder')
