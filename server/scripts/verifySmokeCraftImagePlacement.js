...
const requirements = [
  ...
  {
    name: 'SHAPE SIZE BURN.1.png',
    sourceCandidates: ['public/SHAPE SIZE BURN.1.png', 'public/smokecraft/images/cigar-shape-size.png'],
    cropAsset: 'public/assets/smokecraft/cropped/format-master-tip.jpg',
    component: 'src/pages/smokecraft/Format.jsx',
    oldGeneric: '/assets/smokecraft/cropped/humidor-match-bg.jpg',
  },
  {
    name: 'GOLDEN BOX JOURNEY.png',
    sourceCandidates: ['public/GOLDEN BOX JOURNEY.png', 'public/assets/smokecraft/smokecraft-scorecard.png'],
    cropAsset: 'public/assets/smokecraft/cropped/scorecard-bg.jpg',
    component: 'src/pages/smokecraft/Scorecard.jsx',
  },
  {
    name: 'lounge demo ranking.png',
    sourceCandidates: ['public/lounge demo ranking.png', 'public/assets/smokecraft/golden-box.png'],
    cropAsset: 'public/assets/smokecraft/cropped/golden-box-hero.jpg',
    component: 'src/pages/smokecraft/Leaderboard.jsx',
  },
  {
    name: 'DISCOVER YOUR PROFILE.png',
    sourceCandidates: ['public/DISCOVER YOUR PROFILE.png', 'public/assets/smokecraft/DISOVER YOUR CIGAR PROFILE.png'],
    cropAsset: 'public/assets/smokecraft/cropped/discover-profile-bg.jpg',
    component: 'src/pages/SmokeCraft.jsx',
    oldGeneric: '/assets/smokecraft/cropped/management-sync-bg.jpg',
  },
]
