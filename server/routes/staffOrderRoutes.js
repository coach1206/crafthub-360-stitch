...
router.post  ('/venue/:venueId/tables/:tableId/layout-position',    c.layoutChangePreview)
router.post  ('/venue/:venueId/table-layout/reset-preview',         c.resetLayout)
router.post  ('/venue/:venueId/sections/:sectionId/default-layout', c.defaultSectionLayout)
