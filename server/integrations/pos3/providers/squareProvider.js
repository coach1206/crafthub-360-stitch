/**
 * Square Provider Adapter — Phase 9
 * Adapter is prepared. Credentials not yet configured.
 * All functions return not_configured until SQUARE_ACCESS_TOKEN + SQUARE_LOCATION_ID are set.
 */
...
export const getProviderName        = () => 'Square'
