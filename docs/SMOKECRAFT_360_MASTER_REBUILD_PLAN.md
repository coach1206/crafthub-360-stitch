...
**Recommended next package:** the Entry-layer screens (E3 Select Venue or Lounge, E5 Resume or Start New Journey) per §3f/§12 — the last remaining gap in the full Entry + 27-session spine.
