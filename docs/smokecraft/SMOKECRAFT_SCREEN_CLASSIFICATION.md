...
| **unclassified** | **0** |
| **fully migrated (SmokeCraftScreenShell + nav registry)** | **37** (7 Holistic Fix 2A + 16 Golden Box Holistic Fix 2B + 9 Origins/Curation module Holistic Fix 2C + 5 Pairing-adjacent Holistic Fix 2D) |
