...
| 6 | /smokecraft/cut-toast-light | **P (Holistic Fix 2E-7)** — "Cut, Toast & Light" via SmokeCraftLessonInfoButton | P — cut style selection (Straight/V-Cut/Punch) | **P (Holistic Fix 2E-7 — SmokeCraftLessonInfoButton)** | I | P — cut picker + "Learn Why" disclosure | **P (Holistic Fix 2E-7 — SmokeCraftLessonInfoButton)** | Same pattern as Session 5 — a real "Learn Why" exists but content behind a click |
